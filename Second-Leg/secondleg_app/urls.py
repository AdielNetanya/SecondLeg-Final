...
urlpatterns = [
                  ...
                  path('advertisement/add/', views.add_advertisement, name='add_advertisement'),
                  path('advertisement/<int:ad_id>/', views.advertisement_detail, name='advertisement_detail'),
                  path('advertisement/<int:advertisement_id>/', views.advertisement_detail,
                       name='advertisement_detail'),
                  path('advertisement/<int:advertisement_id>/edit/', views.advertisement_edit,
                       name='advertisement_edit'),
                  path('advertisements/<int:advertisement_id>/delete/', views.advertisement_delete,
                       name='advertisement_delete'),  # Edit view for a specific advertisement
